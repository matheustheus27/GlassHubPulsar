 ...
 * GlassModernTemplate
 * 
 * High-tech glassmorphism with vivid cyan glowing accents,
 * specular translucent borders, and clean Roboto typography.
 */

function generateStyles(s = {}) {
  const isLight = s.theme === 'light';
  const card = s.card || { borderColor: isLight ? '#cbd5e1' : 'rgba(56, 189, 248, 0.25)', backgroundColor: isLight ? '#ffffff' : 'rgba(15, 23, 42, 0.65)' };
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .badge {
        ...
        border: 1px solid ${chip.borderColor || (isLight ? 'rgba(15, 23, 42, 0.15)' : 'rgba(56, 189, 248, 0.3)')} !important;
